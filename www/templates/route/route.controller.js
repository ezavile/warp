(function(){
	...
	RouteCtrl.$inject=['$scope', '$state','$stateParams','NgMap'];
	function RouteCtrl($scope, $state,$stateParams,NgMap){
		...
		$scope.verLugar = function(l){
			$state.go('lugar', {id: $scope.lugarSelected.id, bus: $scope.bus.id});
		}
